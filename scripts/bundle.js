...
/**
 *  IMPORTANT: This file needs to be in sync with all build updates in the official React VR library
 */
...
new Promise((resolve, reject) => {
    ...
    return Promise.all([
        buildScript(
            projectDir,
            buildDir,
            path.resolve(projectDir, 'examples/index.vr.js'),
